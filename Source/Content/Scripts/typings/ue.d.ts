...
declare class StubStruct { 
	clone() : StubStruct;
	static C(Other: UObject | any): StubStruct;
}

declare class StructBox { 
	ScriptStruct: ScriptStruct;
	clone() : StructBox;
	static C(Other: UObject | any): StructBox;
	GetStructFromBox(CustomStruct?: StubStruct): {CustomStruct: StubStruct, $: boolean};
	SetStructInBox(CustomStruct?: StubStruct): {StructBox: StructBox};
	static GetStructFromBox(StructBox: StructBox,CustomStruct?: StubStruct): {CustomStruct: StubStruct, $: boolean};
	static SetStructInBox(StructBox?: StructBox,CustomStruct?: StubStruct): {StructBox: StructBox};
}

declare class StructBoxLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): StructBoxLibrary;
	static Find(Outer: UObject, ResourceName: string): StructBoxLibrary;
	static GetDefaultObject(): StructBoxLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): StructBoxLibrary;
	static SetStructInBox(StructBox?: StructBox,CustomStruct?: StubStruct): {StructBox: StructBox};
	static GetStructFromBox(StructBox: StructBox,CustomStruct?: StubStruct): {CustomStruct: StubStruct, $: boolean};
	static C(Other: UObject | any): StructBoxLibrary;
}
